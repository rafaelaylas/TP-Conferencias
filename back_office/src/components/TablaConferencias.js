...
import CrearConferencia from './CrearConferencia';
import ModificarConferencia from './ModificarConferencia';
import EliminarConferencia from './EliminarConferencia';
      ...
      <div className={classes.title}>
        {numSelected > 0 ? (
          <Typography color="inherit" variant="subtitle1">
            {numSelected} Conferencia seleccionado
          </Typography>
        ) : (
...
class TablaConferencias extends React.Component 
{
  state = {
    order: 'asc',
    orderBy: 'id',
  ...
  {
    var i,newArray = [];
    for (i = 0; i < newData.data.trends.length; i++) {
  ...
  componentDidMount()
  {
    ...
    ApiController.getConference(this.okBusqueda.bind(this));
  }
      ...
      <Paper className={classes.root}>
        ...
        <div className={classes.tableWrapper}>
          ...
          <div className={classes.botonesWrapper}>
              ...
              <CrearConferencia></CrearConferencia>
...
TablaConferencias.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(TablaConferencias);